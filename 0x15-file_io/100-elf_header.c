 ...
 *
 * Description: if the file is not an RLF - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 * @e_ident: a pointer to an array containing the ELF class.
 */
void print_entry(unsigned long
		int e_entry, unsigned char
		*e_ident)
{
 ...
 * @elf: the file descriotor of the ELF file
 *
 * Description: if the file cannot be closed - exit code 08.
 */
void close_elf
(int elf)
{
...
/**
 * main  - displays the informatin contained in the ELF header at the
